...
class Admin extends CI_Controller{
	...
	function kamar_kelas_tambah_aksi(){
		...
		// mengalihkan halaman ke halaman data anggota
		redirect(base_url().'admin/gedung_kelas');
	}

	function gedung_kelas_edit($id_kelas_kamar){
	...
	function gedung_kelas_edit_aksi(){
	...
	function gedung_kelas_delete($id_kelas_kamar){
		$where = array('id_kelas_kamar' => $id_kelas_kamar);
		// mengambil data dari database sesuai id
	...
	function gedung_gambar($id_kamar){
		$where = array('id_kamar' => $id_kamar);
		// mengambil data dari database sesuai id

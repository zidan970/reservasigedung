...
<h3>Nama Gedung : <?php echo $no_kamar;?></h3>
<div class="row">
  <div class="col-lg-8">
...
<!-- #Slider Ends -->
  ...
  <div class="spacer"><h4><span class="fa fa-th-list"></span> Informasi Gedung</h4>
...
<div class="enquiry">
  ...
  <h6><span class="fa fa-envelope"></span> Penyewaan Gedung</h6>
  <?php echo form_open('welcome/reservasi/','role="form"'); ?>
    <input type="hidden" name="id_kamar" value="<?php echo $id_kamar;?>">
     <div class="input-group date form_date col-md-12" data-date="" data-date-format="dd/mm/yyyy" data-link-field="dtp_input2" data-link-format="yyyy-mm-dd">
      ...
      <button type="submit" class="btn btn-primary" name="Submit">Booking Gedung</button>
  ...
  <div class='alert alert-danger'>
                                           <span>Gedung Not Avaliable</span>  
                                        </div>

              ...
              <form method="post" action="<?php echo base_url().'admin/kamar_tambah_aksi'; ?>">
                  ...
                  <div class="form-group">
                    <label class="control-label col-md-3">Nama Gedung</label>
                       <div class="col-md-9">
                            <input class="form-control" placeholder="masukkan nama gedung" name="no_kamar">
                        </div>
                  </div>
                  <div class="form-group">
                    <label class="control-label col-md-3">Tarif Gedung</label>
                       <div class="col-md-9">
                            <input type="number" class="form-control" placeholder="masukkan tarif gedung" name="harga_kamar" min="1">
                        </div>
                  </div>
                  <div class="form-group">
